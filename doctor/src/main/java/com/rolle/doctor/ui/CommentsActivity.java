 ...
 */
public class CommentsActivity extends BaseActivity implements PublicViewAdapter.ICommonGetView<RecommendedItemInfo>, PublicViewAdapter.ICommonOnClick {
    ...
    public void request(){
        ...
        model.requestRecommendReviewComplaints("22",new HttpModelHandler<String>() {
            @Override
