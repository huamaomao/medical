...
public class MaterialTabHost extends RelativeLayout implements View.OnClickListener {
	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                // custom attributes
				hasIcons = a.getBoolean(R.styleable.MaterialTabHost_hasIcons, true);
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, Color.WHITE);
