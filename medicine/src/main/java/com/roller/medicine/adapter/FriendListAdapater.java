...
public class FriendListAdapater extends RecyclerView.Adapter<FriendListAdapater.ViewHolder> {
    ...
    public FriendListAdapater(Context mContext, List<UserInfo> data, int type) {
    ...
    @Override
        public void onBindViewHolder(ViewHolder holder, int position) {
            final UserInfo user=data.get(position);
   ...
   /* public  static class MessageViewHolder extends ViewHolder{
    ...
    public void addCleanItems(List<UserInfo> items){
        if (CommonUtil.notNull(items)){
            this.data.clear();
