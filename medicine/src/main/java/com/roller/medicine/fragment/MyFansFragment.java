...
public class MyFansFragment extends BaseToolbarFragment{
...
//		listView.setOnItemClickListener(this);
		adapter = new PublicViewAdapter<MyFocusFansCommentsItemInfo>(
				getActivity(), mDatas, R.layout.listview_onfans, this, this, Constants.TAG.TAG_NONE);
	...
	private void getRelationListByMap(){
		try {
			DataService.getInstance().getRelationListByMap(this, BaseApplication.TOKEN, Constants.ONFANS);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	*//**
	...
	public void commonGetView(PublicViewHolder helper, MyFocusFansCommentsItemInfo item,
		...
		TextView text_item_focus = helper.getView(R.id.text_item_focus);
		ImageView image_item_next = helper.getView(R.id.image_item_next);
