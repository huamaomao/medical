...
public class MyItemInfo {
	...
	public String toString() {
		return "MyItemInfo [id=" + id + ", groupId=" + groupId + ", userId="
				+ userId + ", appellation=" + appellation + ", createTime="
				+ createTime + ", disabled=" + disabled + ", isImportance="
				+ isImportance + ", headImage=" + headImage + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MyItemInfo other = (MyItemInfo) obj;
		if (appellation == null) {
