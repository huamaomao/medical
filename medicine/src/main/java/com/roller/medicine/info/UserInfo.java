 ...
 * 用户
 */
public class UserInfo extends ResponseMessage implements Parcelable {
    /****message***/
    ...
    public UserInfo(DoctorDetail doctorDetail, PatientDetail patientDetail) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.workAddress);
        dest.writeString(this.workRegionId);
        dest.writeString(this.workRegion);
        dest.writeString(this.jobId);
