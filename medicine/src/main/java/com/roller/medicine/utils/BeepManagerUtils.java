...
/**
 * Manages beeps and vibrations for {@link QRCodeCaptureActivity}.
 * 
 * 管理新信息新消息铃声和震动
 * 
 */
public final class BeepManagerUtils {

	private static final String TAG = BeepManagerUtils.class.getSimpleName();
	 ...
	 * @param context
	 */
	public BeepManagerUtils(Context context) {
