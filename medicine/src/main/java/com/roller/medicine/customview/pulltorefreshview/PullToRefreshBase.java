...
import com.roller.medicine.customview.pulltorefreshview.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	 ...
	 *            延迟时间
	 */
	public void doPullLoding(final boolean smoothScroll, final long delayMillis) {
		postDelayed(new Runnable() {
			@Override
			public void run() {
				int newScrollValue = -mHeaderHeight;
				...
				smoothScrollTo(mFooterHeight, duration, 0);
			}
		}, delayMillis);
	}
